        ...
        static const std::vector<Section> s {
            ...
            { "topbar", "Top bar",
              ...
              true,
              {
                ...
                { "",          "REC / STOP",       "Records everything you hear (the master output) to an audio file; tap again to stop and save.",
                  "REC starts a take of any length; STOP opens a save dialog -- WAV, FLAC, Ogg or MP3." },
